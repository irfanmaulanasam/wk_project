<template>
  <div id="services">
    ...
    <div class="container" v-for="(data, index) in images" :key="index">
      ...
      <div class="row">
        <div class="column-66">
          ...
          <p>
            <span style="font-size: 36px">Take photos like a pro.</span> You
            should buy this app because lorem ipsum consectetur adipiscing elit,
        ...
        <div class="column-33">
          <img :src="require(`@/assets/services/${data.img}.${data.kind}`)"
      ...
      <div class="row">
        ...
        <div class="column-66">
          ...
          <p>
            ...
            veniam, quis nostrud exercitation ullamco laboris nisi ut aliquipex
